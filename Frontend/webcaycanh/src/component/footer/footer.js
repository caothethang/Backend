        ...
        <div className="footer">
            <div className='footer__content'>
                <div className='footer__contact'>
                    <img src="https://totorogarden.com/wp-content/uploads/2020/04/rsz_logo-01.png" alt='#'/>
                ...
                <div className='footer__social'>
                    <h3>FACEBOOK</h3>
                    <img className='img-fb' src="https://totorogarden.com/wp-content/uploads/2020/04/860c3629ca60313e6871-1024x683.jpg" alt='#'/>
                </div>
